    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-2xl border bg-white shadow-sm overflow-hidden">
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <h2 className="text-center text-lg italic text-gray-600">Información de la Marca</h2>

          <form
            className="max-w-xl mx-auto space-y-4"
            onSubmit={handleSubmit(async (v) => {
              setSaving(true);
              // “guardamos” la elección y pasamos al paso 2
              navigate("/brands/new/titular", { state: { brand_name: v.brand_name} });
            })}
          >
            <div>
              <label className="block text-sm font-medium">Marca a registrar</label>
              <input
